...
import './CashOnDel.css'

function CashOnDel() {
  return (
    <div className='cash__del'>
       <div className='cashtermsOfSale'>
        <p className='cash__terms__title'>Terms of Sales</p>
        <p className='cash__terms__para'>
        ...
        We will keep you updated on your order status via email. You may cancel your order in My Orders via the "Cancel" button, or contact at our Customer Support at <span className='cash__links'>https://www.urbanTribe.in.
      ...
      <div className='cash__ship'>
        <p className='cash__title'>
        Order Tracking:
        </p>
        <p className='cash__para'>
        Please visit the “My Orders” section on www.urbanTribe.com and click on the order number.<br/><br/>
        Kindly get in touch with our customer support team for more details at <span className='cash__links'>
        orders.in@urbanTribe.com
          </span>
        </p>
      </div>
      <div className='cash__order__refund'>
      <p className=' cash__title'>
        Order Tracking:
        </p>
        <p className='cash__para'>
