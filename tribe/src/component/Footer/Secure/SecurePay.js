...
function SecurePay() {
  return (
    <div className='secure__pay'>
     <div className='securetermsOfSale'>
        <p className='secure__terms__title'>Terms of Sales</p>
        <p className='secure__terms__para'>
        ...
        We will keep you updated on your order status via email. You may cancel your order in My Orders via the "Cancel" button, or contact at our Customer Support at <span className='secure__links'>https://www.urbanTribe.in
      ...
      <div className='secure__ship'>
        <p className='secure__title'>
        Order Tracking:
        </p>
        <p className='secure__para'>
        Please visit the “My Orders” section on www.urbanTribe.com and click on the order number.<br/><br/>
        Kindly get in touch with our customer support team for more details at <span className='secure__links'>
        orders.in@urbanTribe.com
          </span>
        </p>
      </div>
      <div className='secure__order__refund'>
      <p className=' secure__title'>
        Order Tracking:
        </p>
        <p className='secure__para'>
      ...
      <div className='secure__shipping'>
        <p className='secure__title'>
